...
func TestClamp(t *testing.T) {
	...
	require.InEpsilon(t, 2.0, xmath.Clamp(stdmath.Inf(1), 1.0, 2.0), 0)
	require.InEpsilon(t, 1.0, xmath.Clamp(stdmath.Inf(-1), 1.0, 2.0), 0)
	// NaN clamps to lo instead of propagating.
	require.InEpsilon(t, 1.0, xmath.Clamp(stdmath.NaN(), 1.0, 2.0), 0)
}
...
func TestClamp01(t *testing.T) {
	...
	require.Zero(t, xmath.Clamp01(stdmath.NaN()))
	require.InEpsilon(t, 1.0, xmath.Clamp01(stdmath.Inf(1)), 0)
	require.Zero(t, xmath.Clamp01(stdmath.Inf(-1)))
}
