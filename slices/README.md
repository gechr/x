...
SortNatural sorts a string slice in place in natural order, so embedded numbers compare by value \("item2" before "item10"\) rather than lexically. See \[xstrings.CompareNatural\].
